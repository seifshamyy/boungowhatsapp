                    ...
                    {selectedChat ? (
                        ...
                        <div className="flex-1 flex items-center justify-center bg-white">
                            <div className="text-center px-4">
                                <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-serenity-light flex items-center justify-center border border-serenity-light">
                                    <svg viewBox="0 0 24 24" width="40" className="text-serenity-teal" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                                        <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                                    </svg>
                                </div>
                                <h2 className="text-slate-900 text-2xl font-bold mb-2">Serenity</h2>
